...
def fetch_destination_images(
    ...
    path under travel/ (→ travel/{dest}/assets, e.g. 'visits/2026-05-30-family-visit' — like make_diagram's
...
def make_diagram(
    ...
    (e.g. 'trips/2026-09-birthday-window'); the SVG lands at {dest}/visuals/{name}.svg.
