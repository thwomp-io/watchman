...
class TravelService:
    ...
    def write_flights_report(
        ...
        *,
        ...
        turns live cabin-compared fares into a bring-to-partner corpus doc (mirrors lodging)."""
    ...
    def write_lodging_report(
        ...
        *,
        ...
        deepen-after-pick artifact that turns live results into a bring-to-partner corpus doc."""
