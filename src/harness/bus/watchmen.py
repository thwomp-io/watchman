...
PULSE_LOG = Path.home() / ".local/state/harness/pulse.log"
...
class AgentHealth(BaseModel):
    ...
    id: str
    label: str
    state: str  # "green" (on-schedule) | "red" (missed a due run)
    healthy: bool
    market_day: bool
...
class WatchmenStatus(BaseModel):
    ...
    as_of: str
    overall: str  # worst agent state — "green" | "red"
...
def compute_watchmen_status(
    ...
    agents = [pulse]
    overall = "red" if any(a.state == "red" for a in agents) else "green"
