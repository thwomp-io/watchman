...
function renderFoodBank(root, d) {
  ...
  // booked/banked/new (the default booked/banked/new semantics) so the same grouped-card engine serves any option
...
function renderMap(root, d) {
  const origin = d.origin || { label: "Home", lat: 47.61, lon: -122.33 };
