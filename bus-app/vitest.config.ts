...
// Frontend component-test tier (the webview-behavior gate). The React render layer runs in
...
// What it does NOT cover: the real Rust↔webview boundary (that's the Rust unit tests + the "operator saw
